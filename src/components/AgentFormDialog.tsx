...
export function AgentFormDialog({ open, onOpenChange, agent, onSaved }: Props) {
  ...
  const save = () => {
    ...
    if (dup) {
      toast.error(`Duplicate: ${dup.name} — ${dup.agency}`);
      return;
    }
        ...
        <div className="space-y-5">
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <Label>IATA</Label>
                <Input value={f.iata || ""} onChange={(e) => set("iata", e.target.value)} />
              </div>
              <div>
              ...
              <div>
                ...
                <Select
                  value={f.preferred_currency || "INR"}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    set("credit_limit", e.target.value === "" ? undefined : Number(e.target.value))
                  }
                />
              </div>
              <div className="col-span-2">
              ...
              <div className="col-span-2">
                ...
                <Input
                  value={f.relationship_owner || ""}
                  onChange={(e) => set("relationship_owner", e.target.value)}
                  placeholder="Organisation-level owner; may differ from Query handler"
                />
              </div>
            </div>
          </section>
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="col-span-2">
                ...
                <Textarea
                  rows={2}
                  value={f.internal_remarks || ""}
                  onChange={(e) => set("internal_remarks", e.target.value)}
                />
              </div>
            </div>
          </section>
