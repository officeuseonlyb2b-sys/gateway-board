...
const PERMISSIONS = [
  ...
  ["query.read", "View all Unit Queries"],
  ["query.read.own", "View own Queries"],
  ["query.work", "Work any Unit Query"],
  ["query.work.own", "Work assigned Queries"],
  ["query.assign", "Assign / reassign Queries"],
  ["query.assignment.receive", "Can receive Sales Queries"],
  ["quotation.create", "Prepare Costing / Quotation"],
  ["quotation.send", "Send Quotation"],
  ["task.manage", "Manage team tasks"],
  ["performance.read", "View performance analytics"],
  ["employee.manage", "Manage employees and access"],
] as const;
...
export default function UsersRoles() {
    ...
    setForm(
      emp
        ? {
            ...
            login_email_pending: emp.login_email_pending,
  ...
  const save = () => {
    ...
    const payload = {
      ...form,
      login_email_pending: form.email.endsWith("@employee.local"),
    };
    if (editing) {
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Employee register — designation, department and access profile are independent. Only
            authorised Sales-pool members receive Query assignments.
          </p>
        </div>
          ...
          <table className="w-full text-sm">
            <thead className="bg-muted/50 text-left text-xs uppercase text-muted-foreground">
              <tr>
                ...
                <th className="p-3">Access profile / designation</th>
              ...
              {employees.map((e) => (
                <tr key={e.id} className="border-t">
                  ...
                  <td className="p-3 text-muted-foreground">
                    {e.login_email_pending ? (
                      <>
                        <Badge variant="outline">Login email pending</Badge>
                        <br />
                        <span className="text-xs">Set the employee's actual login email</span>
                      </>
                    ) : (
                      e.email
                    )}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Organisational title shown in team lists. It does not by itself grant access.
              </p>
            </div>
            <div className="space-y-2">
              <Label>Email *</Label>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Use “Can receive Sales Queries” only for cross-department employees who should
                appear in the assignment pool.
              </p>
            </div>
            <div className="space-y-2">
